...
- **As of:** 2026-06-18 (last change **CHG-0034**)
...
- **MVP transactional backend complete** (procure-to-pay + order-to-cash). **Frontend** drives both
  ...
  submit→receive→bill→pay supplier), plus app shell, light/dark toggle, login, finance dashboard, and
  **Accounting reports** (Trial Balance / P&L / Balance Sheet). Reusable DataTable/StatusBadge/form
  kit. Next frontend: Inventory + Master-data screens, ⌘K palette, `id` locale.
