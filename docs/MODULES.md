...
| Data Import/Export | 🟡 Partial | Cross-cutting — CSV import for all master data (CHG-0049/0050); CSV+Excel export across all list menus (master data, sales, purchasing, inventory, expenses — CHG-0051, ClosedXML); PDF (reports/docs) + async pending (ADR-0031) |
