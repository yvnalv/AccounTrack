...
| Data Import/Export | 🟡 Partial | Cross-cutting — CSV template/preview/commit/export for all master data (customers/suppliers/warehouses/products — CHG-0049/0050); Excel/PDF + async pending (ADR-0031) |
