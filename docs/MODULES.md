...
| Sales | 🟡 Slice 1 + Delivery | Sales Orders (Approval + event-driven status); **Delivery Order** (atomic stock issue + Dr COGS/Cr Inventory at moving-average). Slice 2 remaining: Sales Invoice (AR/Revenue/VAT), Customer Payment |
