...
<template>
  <div class="space-y-4">
    ...
    <DataTable searchable clickable :columns="columns" :rows="visibleRows" :loading="loading" :empty-text="t('returns.purchaseEmpty')" :filters-active="!!supplierFilter" @row-click="open" @clear="supplierFilter = ''">
      <template #filters>
