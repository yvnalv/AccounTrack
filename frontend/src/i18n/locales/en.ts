export default {
  ...
  priceLists: {
    subtitle: 'Sell and buy prices per product. A default list per type applies unless a customer or supplier has its own.',
    new: 'New price list',
    ...
    default: 'Default',
    defaultHint: 'Use as the default list for its type',
    activeHint: 'Active',
    itemsCount: 'Products',
    items: 'Prices',
    empty: 'No price lists yet. Create one, then add product prices.',
    product: 'Product',
    selectProduct: 'Select a product',
    price: 'Unit price',
    addItem: 'Add',
    noItems: 'No prices in this list yet.',
    close: 'Close',
    assign: {
      sales: 'Sales price list',
      purchase: 'Purchase price list',
      none: 'Company default',
      hint: 'Overrides the company default list for this party. Order lines auto-fill from it.',
    },
  },
}
