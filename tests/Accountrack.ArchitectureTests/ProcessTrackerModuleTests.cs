...
/// <summary>Clean-architecture boundary rules for the Process Tracker module (ADR-0002/0023).</summary>
public class ProcessTrackerModuleTests
{
    private static readonly Assembly Domain = typeof(ProcessEvent).Assembly;
    private static readonly Assembly Application = typeof(GetTimelineQuery).Assembly;
    ...
    public void Application_should_not_depend_on_EfCore_AspNet_or_Infrastructure()
    {
        var result = Types.InAssembly(Application)
            ...
            .HaveDependencyOnAny("Microsoft.EntityFrameworkCore", "Microsoft.AspNetCore",
                "Accountrack.ProcessTracker.Infrastructure")
            .GetResult();
